...
# --- Output Redirection ------------------------------------------------------
echo -e "\n${YELLOW}[2] Output Redirection (>)${NC}"
...
echo -e "\n${YELLOW}[5] Input + Output Together${NC}"
...
# --- Composed Compounds -------------------------------------------
echo -e "\n${YELLOW}[7] Composed Compounds ${NC}"
...
# --- Shell Lifecycle ---------------------------------------------------------
echo -e "\n${YELLOW}[10] Shell Lifecycle & Edge Cases${NC}"
...
# --- Local Executable --------------------------------------------------------
echo -e "\n${YELLOW}[11] Local Executable & Whitespace${NC}"
